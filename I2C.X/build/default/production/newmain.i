...
void ds1307_setTime(int dow, int date, int mo, int yr, int hr, int mi, int se) {
    ...
    i2c_write(0xD0);
    i2c_write(0x00);
    i2c_write(Decimal_To_BCD(se));
    i2c_write(Decimal_To_BCD(mi));
    i2c_write(Decimal_To_BCD(hr));
    i2c_write(Decimal_To_BCD(dow));
    i2c_write(Decimal_To_BCD(date));
    i2c_write(Decimal_To_BCD(mo));
    i2c_write(Decimal_To_BCD(yr));
    i2c_stop();
}
void i2c_readTime() {
# 65 "./ds1307.h"
